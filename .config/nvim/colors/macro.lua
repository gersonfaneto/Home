...
if vim.go.bg == 'dark' then
  c_autumnGreen  = '#96b67a'
  c_autumnRed    = '#ff4648'
  c_autumnYellow = '#ffc56d'
  c_carpYellow   = '#ffde91'
  c_katanaGray   = '#919c9c'
  c_lotusBlue    = '#bfd5e9'
  c_lotusGray    = '#918e81'
  ...
  c_macroGray1   = '#bebbb3'
  c_macroGray2   = '#9aa3a2'
  c_macroGreen0  = '#a7c9a7'
  c_macroGreen1  = '#aaba9b'
  c_macroOrange0 = '#d6b29b'
  c_macroOrange1 = '#d9ad9b'
  c_macroPink    = '#c2b2c3'
  c_macroRed     = '#e4948e'
  c_macroTeal    = '#b4bfd5'
  c_macroViolet  = '#a9b2c7'
  c_roninYellow  = '#ffbe5b'
  c_springBlue   = '#9fd4ea'
  c_springGreen  = '#b8db8c'
  c_springViolet = '#a39ac9'
  c_sumiInk6     = '#74748d'
  c_waveAqua0    = '#8ab5a9'
  c_waveAqua1    = '#9ac8bf'
  c_waveBlue0    = '#425269'
